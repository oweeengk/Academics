...
int main()
{
    ...
    int choice;
    int given;
    cout << "This program creates a doubly linked list in C++ that can enqueue, dequeue, display, check list, show size and peek\n";
    do{
        printf("\n*********************************************");
        printf("\n\t 1. Enqueue.");
        printf("\n\t 2. Dequeue.");
        ...
        printf("\n\t 5. Show size of the queue.");
        printf("\n\t 6. Show front of the queue.");
        printf("\n\t 0. Exit");
        printf("\n*********************************************");
        printf("\nEnter choice: ");
        cin >> choice;
        switch(choice){
            ...
            case 4:
                ...
                break;
            case 5:
                printf("[5] The size of the queue is: %d", CurrSize);
                break;
            case 6:
				if(isEmpty()){
					printf("[6] Queue is empty! nothing to display.");
				}
				else{
					printf("[6] The front of the queue is: %d", head->data);
				}
                break;
            case 0:
